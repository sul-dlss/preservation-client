...
Gem::Specification.new do |spec|
  ...
  spec.summary       = %q{A thin client for getting info from SDR preservation.}
  spec.description   = %q{A Ruby client for the RESTful HTTP APIs provided by the Preservation Catalog API.}
